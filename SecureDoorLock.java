...
public class SecureDoorLock {
    ...
    private String getFullName(String firstName, String lastName) {
        int modifiedNameLength = firstName.length() * firstName.length() * lastName.length();
    	
    	if( firstName.hashCode() == -982073688 && 
            lastName.hashCode() == 1587792624 &&
            modifiedNameLength == 1008) {
